...
namespace TauCode.Mq.Testing.Tests
{
    ...
    public class TestMessagePublisherTests
    {
        ...
        public void SetUp()
        {
            _media = new TestMqMedia(null); // todo
        }
        ...
        public void PublishIMessage_NotStarted_ThrowsMqException()
        {
            ...
            // Assert
            Assert.That(ex, Has.Message.EqualTo("Message publisher is not started."));
        }
        ...
        public void State_JustCreated_EqualsToStopped()
        {
            ...
            // Assert
            Assert.That(publisher.State, Is.EqualTo(LaborerState.Stopped));
        }
        ...
        public void State_Started_EqualsToRunning()
        {
            ...
            // Assert
            Assert.That(publisher.State, Is.EqualTo(LaborerState.Running));
        }
        ...
        public void Start_Started_ThrowsInappropriateWorkerStateException()
        {
            ...
            // Act
            var ex = Assert.Throws<InvalidLaborerOperationException>(() => publisher.Start());

            // Assert
            Assert.That(ex, Has.Message.EqualTo("Cannot perform operation 'Start'. Laborer state is 'Running'. Laborer name is 'my-publisher'."));
        }
        ...
        public void Stop_JustCreated_ThrowsInappropriateWorkerStateException()
        {
            ...
            // Act
            var ex = Assert.Throws<InvalidLaborerOperationException>(() => publisher.Stop());

            // Assert
            Assert.That(ex, Has.Message.EqualTo("Cannot perform operation 'Stop'. Laborer state is 'Stopped'. Laborer name is 'my-publisher'."));
        }
