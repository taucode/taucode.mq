...
namespace TauCode.Mq.Testing.Tests
{
    ...
    public class TestMessageSubscriberTests
    {
        ...
        public void SetUp()
        {
            ...
            _media = new TestMqMedia(_logger); // todo
        ...
        public void SubscribeType_Started_ThrowsInappropriateWorkerStateException()
        {
            ...
            // Assert
            Assert.That(ex, Has.Message.EqualTo("Message subscriber is not stopped."));
        }
        ...
        public void State_JustCreated_EqualsToStopped()
        {
            ...
            // Assert
            Assert.That(subscriber.State, Is.EqualTo(LaborerState.Stopped));
        }
        ...
        public void State_Started_EqualsToStarted()
        {
            ...
            // Assert
            Assert.That(subscriber.State, Is.EqualTo(LaborerState.Running));
        }
        ...
        public void Start_Started_ThrowsInappropriateWorkerStateException()
        {
            ...
            // Act
            var ex = Assert.Throws<InvalidLaborerOperationException>(() => subscriber.Start());

            // Assert
            Assert.That(ex, Has.Message.EqualTo("Cannot perform operation 'Start'. Laborer state is 'Running'. Laborer name is 'my-subscriber'."));
        }
        ...
        public void Stop_JustCreated_ThrowsInappropriateWorkerStateException()
        {
            ...
            // Act
            var ex = Assert.Throws<InvalidLaborerOperationException>(() => subscriber.Stop());

            // Assert
            Assert.That(ex, Has.Message.EqualTo("Cannot perform operation 'Stop'. Laborer state is 'Stopped'. Laborer name is 'my-subscriber'."));
        }
